...
const FAQS = [
  {
    ...
    answer:
      "A workspace is your team's dedicated instance of Trak - with its own projects, members, and settings. Scale plan users can create as many as their organization needs."
  },
  {
          ...
          <div className={styles.enterpriseBand}>
            <div>
              ...
              <p className={styles.enterpriseCopy}>
                For brands doing serious volume. Enterprise includes dedicated onboarding,
                priority support, custom contract terms, and pricing that scales with your
